...
export const Payments: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-[#7a8345]/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold bg-gradient-to-r from-[#7a8345] to-[#5a6332] bg-clip-text text-transparent">{summary.total_payments.toLocaleString()} FCFA</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-[#5a6332]/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold bg-gradient-to-r from-[#5a6332] to-[#7a8345] bg-clip-text text-transparent">{summary.payment_count}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-[#7a8345]/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold bg-gradient-to-r from-[#7a8345] to-[#5a6332] bg-clip-text text-transparent">{summary.total_mobile_money.toLocaleString()} FCFA</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-[#5a6332]/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold bg-gradient-to-r from-[#5a6332] to-[#7a8345] bg-clip-text text-transparent">{summary.total_cash.toLocaleString()} FCFA</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-[#7a8345]/20 shadow-lg">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <select
            ...
            className="px-4 py-3 border-2 border-[#5a6332]/20 rounded-xl focus:ring-2 focus:ring-[#5a6332]/30 focus:border-[#5a6332] transition-all duration-300 bg-white/80 backdrop-blur-sm"
          >
          ...
          <select
            ...
            className="px-4 py-3 border-2 border-[#7a8345]/20 rounded-xl focus:ring-2 focus:ring-[#7a8345]/30 focus:border-[#7a8345] transition-all duration-300 bg-white/80 backdrop-blur-sm"
          >
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-[#7a8345]/20 shadow-lg overflow-hidden">
        <div className="bg-gradient-to-r from-[#7a8345]/10 to-[#5a6332]/10 p-6 border-b border-[#7a8345]/20">
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            {payments.map((payment) => (
              <div key={payment.id} className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-[#7a8345]/10 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <div className="flex items-center justify-between">
                  <div className="flex-1 grid grid-cols-1 md:grid-cols-6 gap-4">
                    {/* Facture */}
                    <div className="md:col-span-1">
                      <div className="text-xs font-semibold text-[#7a8345] mb-1">FACTURE</div>
                    ...
                    {/* Montant */}
                    <div className="md:col-span-1">
                      <div className="text-xs font-semibold text-[#5a6332] mb-1">MONTANT</div>
                    ...
                    {/* Méthode */}
                    <div className="md:col-span-1">
                      <div className="text-xs font-semibold text-[#7a8345] mb-1">MÉTHODE</div>
                      <div className="flex items-center gap-2">
                        <div className={`w-6 h-6 rounded-lg flex items-center justify-center ${
                          ['wave', 'orange_money'].includes(payment.payment_method)
                            ? 'bg-white border border-neutral-200'
                            : 'bg-gradient-to-br from-[#7a8345] to-[#5a6332] text-white'
                        }`}>
                    ...
                    {/* Date */}
                    <div className="md:col-span-1">
                      <div className="text-xs font-semibold text-[#5a6332] mb-1">DATE</div>
                    ...
                    {/* Statut */}
                    <div className="md:col-span-1">
                      <div className="text-xs font-semibold text-[#7a8345] mb-1">STATUT</div>
                    ...
                    {/* Référence */}
                    <div className="md:col-span-1">
                      <div className="text-xs font-semibold text-[#5a6332] mb-1">RÉFÉRENCE</div>
          ...
          {totalPages > 1 && (
            <div className="flex justify-between items-center mt-6 pt-6 border-t border-[#7a8345]/20">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="px-4 py-2 border-2 border-[#7a8345]/20 rounded-xl disabled:opacity-50 disabled:cursor-not-allowed hover:bg-[#7a8345]/10 transition-all duration-300 font-medium"
                >
                  Précédent
                </button>
                <button
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50" onClick={() => setShowModal(false)}>
          <div className="bg-white/95 backdrop-blur-sm rounded-xl w-full max-w-2xl max-h-[85vh] overflow-y-auto shadow-2xl border border-[#7a8345]/20" onClick={(e) => e.stopPropagation()}>
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    />
                    {formData.invoice && (
                      <p className="text-xs text-[#5a6332] mt-1 font-medium">
                ...
                {['mobile_money', 'orange_money', 'wave', 'free_money'].includes(formData.payment_method) && (
                  <div className="bg-gradient-to-r from-[#7a8345]/5 to-[#5a6332]/5 p-3 rounded-lg border border-[#7a8345]/20">
                    <h4 className="text-xs font-bold text-[#7a8345] mb-2">Informations Mobile Money</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div>
                        <label className="block text-xs font-semibold text-[#7a8345] mb-1">
                          Téléphone
