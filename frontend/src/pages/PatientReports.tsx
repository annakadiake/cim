...
const PatientReports: React.FC = () => {
  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-gradient-to-r from-[#7a8345]/10 to-[#5a6332]/10 rounded-2xl p-6 border border-[#7a8345]/20 mb-6">
      ...
      <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-[#7a8345]/20 p-6 mb-6">
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1">
            <div className="relative">
              <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-[#7a8345] h-5 w-5" />
              <input
                type="text"
                placeholder="Rechercher par nom de patient ou clé d'accès..."
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="w-full pl-12 pr-4 py-3 border-2 border-[#7a8345]/30 rounded-xl focus:ring-2 focus:ring-[#7a8345]/50 focus:border-[#7a8345] transition-all duration-300 bg-white/80 backdrop-blur-sm"
              />
            </div>
          </div>
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 border-2 border-[#5a6332]/30 rounded-xl hover:bg-[#5a6332]/10 transition-all duration-300 text-[#5a6332] font-medium backdrop-blur-sm"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border-2 border-[#7a8345]/30 rounded-xl focus:ring-2 focus:ring-[#7a8345]/50 focus:border-[#7a8345] transition-all duration-300 bg-white/80 backdrop-blur-sm"
                >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-[#7a8345]/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
          <div className="flex items-center">
            <div className="w-12 h-12 bg-gradient-to-br from-[#7a8345] to-[#7a8345]/80 rounded-xl flex items-center justify-center shadow-lg">
              <FileText className="h-6 w-6 text-white" />
            </div>
            <div className="ml-4">
              <p className="text-sm font-medium text-neutral-600">Total</p>
              <p className="text-2xl font-bold bg-gradient-to-r from-[#7a8345] to-[#5a6332] bg-clip-text text-transparent">{reports.length}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-[#5a6332]/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
          <div className="flex items-center">
            <div className="w-12 h-12 bg-gradient-to-br from-[#5a6332] to-[#5a6332]/80 rounded-xl flex items-center justify-center shadow-lg">
              <Download className="h-6 w-6 text-white" />
            </div>
            <div className="ml-4">
              <p className="text-sm font-medium text-neutral-600">Téléchargements</p>
              <p className="text-2xl font-bold bg-gradient-to-r from-[#5a6332] to-[#7a8345] bg-clip-text text-transparent">
      ...
      <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-[#7a8345]/20">
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-[#7a8345]/20">
            <thead className="bg-gradient-to-r from-[#7a8345]/10 to-[#5a6332]/10">
              <tr>
            ...
            <tbody className="bg-white/50 divide-y divide-[#7a8345]/10">
              {filteredReports.map((report) => (
                <tr key={report.id} className="hover:bg-[#7a8345]/5 transition-all duration-200">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="w-8 h-8 bg-gradient-to-br from-[#7a8345]/20 to-[#5a6332]/20 rounded-lg flex items-center justify-center mr-3">
                        <FileText className="h-4 w-4 text-[#7a8345]" />
                      </div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="text-sm font-mono bg-gradient-to-r from-[#7a8345]/10 to-[#5a6332]/10 px-3 py-1 rounded-lg text-neutral-700 border border-[#7a8345]/20">
                      {report.access_key}
                    </span>
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r from-[#5a6332]/10 to-[#5a6332]/20 text-[#5a6332] border border-[#5a6332]/20">
          ...
          {filteredReports.length === 0 && (
            <div className="text-center py-12">
              <div className="w-16 h-16 bg-gradient-to-br from-[#7a8345]/20 to-[#5a6332]/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <FileText className="h-8 w-8 text-[#7a8345]" />
              </div>
      ...
      {showUploadModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50" onClick={() => setShowUploadModal(false)}>
          <div className="bg-white/95 backdrop-blur-sm rounded-xl max-w-md w-full shadow-2xl border border-[#7a8345]/20" onClick={(e) => e.stopPropagation()}>
            <div className="flex justify-between items-center px-5 py-3 border-b border-[#7a8345]/20 bg-gradient-to-r from-[#7a8345]/10 to-[#5a6332]/10 rounded-t-xl">
            ...
            <form onSubmit={handleUpload} className="space-y-3 px-5 py-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-[#5a6332]/20 rounded-lg focus:ring-2 focus:ring-[#5a6332]/30 focus:border-[#5a6332] transition-all text-sm file:mr-3 file:py-1 file:px-3 file:rounded file:border-0 file:text-xs file:font-medium file:bg-gradient-to-r file:from-[#7a8345] file:to-[#5a6332] file:text-white"
                  required
                />
                <p className="text-xs text-neutral-500 mt-1 bg-[#7a8345]/5 px-2 py-1 rounded border border-[#7a8345]/10">
              ...
              <div className="flex justify-end gap-2 pt-3 border-t border-[#7a8345]/10">
                ...
                <button
                  type="submit"
                  disabled={uploading}
                  className="px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-[#7a8345] to-[#5a6332] rounded-lg hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {uploading ? (
